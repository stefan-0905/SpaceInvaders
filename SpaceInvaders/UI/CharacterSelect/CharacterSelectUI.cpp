...
CharacterSelectUI::CharacterSelectUI()
{
	...
	manager.AddActor<SImage>("res/Slinger.png", 50, 100, WINDOW_SIZE_X / 2 - 50, WINDOW_SIZE_Y / 2);
	manager.AddActor<SImage>("res/Bazooker.png", 50, 100, WINDOW_SIZE_X / 2 + 50, WINDOW_SIZE_Y / 2);
